...
def print_menu():
    ...
    print(Fore.LIGHTYELLOW_EX + "3.", Fore.BLUE + "Reconstruct tree")
    print(Fore.LIGHTYELLOW_EX + "4.", Fore.BLUE + "Wolf, Goat, Cabbage problem solution")
    print(Fore.LIGHTYELLOW_EX + "5.", Fore.BLUE + "15-puzzle problem solution")
