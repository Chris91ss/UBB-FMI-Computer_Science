...
class UndirectedGraphUI:
    ...
    def run_app(self):
        ...
        input_options = {
            ...
            "2B": self.__find_biconnected_components_using_tarjans_algorithm,
        }
    ...
    def print_menu():
        ...
        print(Fore.LIGHTYELLOW_EX + "2B.", Fore.BLUE + "Find the biconnected components of an undirected graph in O(n+m)"
