...
class DirectedGraphUI:
    ...
    def run_app(self):
        ...
        input_options = {
            ...
            "1B": self.__find_strongly_connected_components_using_kosarajus_algorithm,
        }
    ...
    def print_menu():
        ...
        print(Fore.LIGHTYELLOW_EX + "1B.", Fore.BLUE + "Find the strongly connected components using Kosaraju's algorithm")
